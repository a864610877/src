            ...
            var query = (new[]
                        {
                            ...
                            new Permission {DisplayName = "帐户管理",    Category = "会员事务",Name = Permissions.Account, UserTypes = adminUserType},
                            ...
                            new Permission {DisplayName = "门票编辑",    Category = "门票管理",  Name = Permissions.AdmissionTicketEdit, UserTypes = adminUserType},
                            new Permission {DisplayName = "门票列表",    Category = "门票管理",  Name = Permissions.AdmissionTicketList, UserTypes = adminUserType},
                            new Permission {DisplayName = "门票添加",    Category = "门票管理",  Name = Permissions.AdmissionTicketCreate, UserTypes = adminUserType},
                            new Permission {DisplayName = "门票删除",    Category = "门票管理",  Name = Permissions.AdmissionTicketDelete, UserTypes = adminUserType},
                            ...
                            new Permission {DisplayName = "文章管理",    Category = "文章管理",  Name = Permissions.ArticlesEdit, UserTypes = adminUserType},
                             ...
                             new Permission {DisplayName = "订单列表", Category = "报表",Name = Permissions.OrdersList, UserTypes = adminUserType},
                             new Permission {DisplayName = "订单列表导出", Category = "报表",Name = Permissions.OrdersListReport, UserTypes = adminUserType},
