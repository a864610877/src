namespace Ecard.Models
{
    public class LogTypes
    {
        ...
        /// 添加门票
        /// </summary>
        public const int AddAdmissionTicketCreate = 801;
        /// <summary>
        /// 门票停售
        /// </summary>
        public const int AdmissionTicketSuspend = 802;
        /// <summary>
        /// 门票启用
        /// </summary>
        public const int AdmissionTicketResume = 803;
        /// <summary>
        /// 门票删除
        /// </summary>
        public const int AdmissionTicketDelete = 804;
        /// <summary>
        /// 门票编辑
        /// </summary>
        public const int AdmissionTicketEdit = 810;

        /// <summary>
        /// 添加优惠卷
        /// </summary>
        public const int CouponCreate = 805;
        /// <summary>
        /// 优惠卷停售
        /// </summary>
        public const int CouponSuspend = 806;
        /// <summary>
        /// 优惠卷启用
        /// </summary>
        public const int CouponResume = 807;
        /// <summary>
        /// 优惠卷删除
        /// </summary>
        public const int CouponDelete = 808;
        /// <summary>
        /// 编辑优惠卷
        /// </summary>
        public const int CouponEdit = 809;
