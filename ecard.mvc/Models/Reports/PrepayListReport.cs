...
{
    public class PrepayListReport : EcardModelReportRequest
    {
        ...
        {
            yield return new ActionMethodDescriptor("PrepayListExport", "Report", new { export = "excel" }) { IsPost = true };
