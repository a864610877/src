...
namespace Ecard.Mvc.Controllers
{
    ...
    public class SiteController : Controller
    {
        ...
        [CheckPermission(Permissions.SystemSettings)]
        public ActionResult EditTicketTemplate()
        {
            var model = _unityContainer.Resolve<EditTicketTemplate>();
            model.Ready();
            return View(new EcardModelItem<EditTicketTemplate>(model));
        } 

        [HttpPost]
        [CheckPermission(Permissions.SystemSettings)]
        public ActionResult EditTicketTemplate([Bind(Prefix = "Item")] EditTicketTemplate model)
        {
            if (ModelState.IsValid)
            {
                this.ModelState.Clear();
        ...
        [CheckPermission(Permissions.SystemSettings)]
        public ActionResult EditMessageTemplate()
        {
            var model = _unityContainer.Resolve<EditMessageTemplate>();
            model.Ready();
